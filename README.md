...
Тесты гоняются на in-memory SQLite через httpx + ASGITransport (без
поднятия реальной БД) и включают отдельные проверки на конкурентные
запросы к одному кошельку.
